...
data Declaration
  ...
  | DataSig     Range ArgInfo Name [LamBinding] Expr -- ^ lone data signature in mutual block
  | Data        Range ArgInfo Name [LamBinding] Expr [TypeSignatureOrInstanceBlock]
  | DataDef     Range Name [LamBinding] [TypeSignatureOrInstanceBlock]
  | RecordSig   Range ArgInfo Name [LamBinding] Expr -- ^ lone record signature in mutual block
  | RecordDef   Range Name RecordDirectives [LamBinding] [Declaration]
  | Record      Range ArgInfo Name RecordDirectives [LamBinding] Expr [Declaration]
...
instance KillRange Declaration where
  ...
  killRange (DataSig _ i n l e)     = killRange3 (DataSig noRange) i n l e
  killRange (Data _ i n l e c)      = killRange4 (Data noRange) i n l e c
  killRange (DataDef _ n l c)       = killRange3 (DataDef noRange) n l c
  killRange (RecordSig _ i n l e)   = killRange3 (RecordSig noRange) i n l e
  ...
  killRange (Record _ i n dir k e d) = killRange5 (Record noRange) i n dir k e d
